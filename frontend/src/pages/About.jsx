...
const translations = {
  uk: {
    ...
    intro: 'DrivePoint — это інноваційний онлайн маркетплейс для продажу та покупки автомобілів і мотоциклів. Ми спрощуємо процес пошуку ідеального транспорту для вас.',
    mission: 'Наша місія',
