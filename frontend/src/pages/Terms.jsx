...
const translations = {
  uk: {
    ...
    section3Text: 'Для використання певних функцій платформи ви повинні створити обліковий запис. Ви несете відповідальність за його безпеку.',
    section4: 'Наслідки',
    section4Text: 'DrivePoint не несе жодної відповідальності за непрямі, випадкові або наслідки втрат.',
    section5: 'Технічна підтримка',
